    ...
    public partial class Initaial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("d276b5eb-7e1d-4347-96bf-ce5931bde593"), "d8d08634-d721-4154-86af-82e02e3c0f79", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("4ff07ec1-1521-4f74-92e8-b03f26a72a96"), 0, "a6064542-8cda-408f-bc3b-eb9b84e06be6", new DateTime(2023, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "minhvv@rikkeisoft.com", true, "Minh", "Vu", false, null, "minhvv@rikkeisoft.com", "admin", "AQAAAAEAACcQAAAAEJKn6mSTyW1o5+/sJUe+KuztH0kcZg23DMboIKnrn7QbMFBW67nq4g6B7y5VcmI/Bg==", null, false, "", false, "admin" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "IsShowOnHome", "ParenId", "SortOrder", "Status" },
                values: new object[,]
                {
                    { 1, true, null, 1, 1 },
                    { 2, true, null, 2, 1 }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 3, 2, 11, 28, 58, 694, DateTimeKind.Local).AddTicks(5964), true, 100000m, 200000m });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DateCreated", "IsFeatured", "OriginalPrice", "Price", "Stock" },
                values: new object[] { 2, new DateTime(2023, 3, 2, 11, 28, 58, 695, DateTimeKind.Local).AddTicks(3622), false, 200000m, 300000m, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10, "Thumbnail image", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 18759L, "/themes/images/products/b1.jpg", true, 1, 1 },
                    { 13, "Thumbnail image", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 5353L, "/themes/images/products/7.jpg", true, 1, 4 },
                    { 14, "Thumbnail image", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 231231L, "/themes/images/products/9.jpg", true, 1, 4 },
                    { 11, "Thumbnail image", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 39972L, "/themes/images/products/b2.jpg", true, 2, 4 },
                    { 12, "Thumbnail image", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 39972L, "/themes/images/products/6.jpg", true, 2, 4 },
                    { 15, "Thumbnail image", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 231231L, "/themes/images/products/8.jpg", true, 2, 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Torado Men T-Shirt", "Torado Men T-Shirt", "vi", "Torado T-Shirt", 2, "Torado-t-shirt", "Torado Men T-Shirt", "Torado Men T-Shirt" }
                });
